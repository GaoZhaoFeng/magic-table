...
@SpringBootTest
class MongoDBInsertIconsTest {

    @Autowired
    MongoTemplate mongoTemplate;


    List<Document> genData() {
        String[] icons = {
                "24-hours-fill",
                "24-hours-line",
                "4k-fill",
    ...
    @Test
    void addDevices() {
        MongoCollection<Document> device = mongoTemplate.getCollection("icon");
        List<Document> docs = genData();
